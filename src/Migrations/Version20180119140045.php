 ...
 */
class Version20180119140045 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE Comments (id INT AUTO_INCREMENT NOT NULL, question_id INT DEFAULT NULL, post_id INT DEFAULT NULL, user_id INT DEFAULT NULL, content LONGTEXT NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_A6E8F47C1E27F6BF (question_id), INDEX IDX_A6E8F47C4B89032C (post_id), INDEX IDX_A6E8F47CA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE Comments ADD CONSTRAINT FK_A6E8F47C1E27F6BF FOREIGN KEY (question_id) REFERENCES questions (id)');
